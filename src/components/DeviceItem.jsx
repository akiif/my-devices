  ...
  return (
    <div className="device-item">
      ...
      <div className="device-details">
        <p className="desc">
          <span className="desc-header">Released Date:&nbsp;</span>{" "}
          {item.released_date ? item.released_date : "NA"}
        </p>
        <p className="desc">
          <span className="desc-header">Acquired Date:&nbsp;</span>{" "}
        ...
        <p className="desc" style={{ display: "none" }}>
          ...
          {item.usedTill ? item.usedTill : "NA"}
        </p>
        <p className="desc" style={{ display: "none" }}>
          <span className="desc-header">Note:&nbsp;</span>{" "}
